...
var wasmBinaryFile = 'spacetime.wasm';
...
var ASM_CONSTS = [function() {spacetime_initialized()}];
...
var asmGlobalArg = {};
var asmLibraryArg = { "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "__assert_fail": ___assert_fail, "__setErrNo": ___setErrNo, "__syscall140": ___syscall140, "__syscall146": ___syscall146, "__syscall6": ___syscall6, "_computeUnpackAlignedImageSize": __computeUnpackAlignedImageSize, "_findCanvasEventTarget": __findCanvasEventTarget, "_findEventTarget": __findEventTarget, "_glGenObject": __glGenObject, "_heapObjectForWebGLType": __heapObjectForWebGLType, "abort": _abort, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "emscriptenWebGLGetTexPixelData": emscriptenWebGLGetTexPixelData, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_get_heap_size": _emscripten_get_heap_size, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_realloc_buffer": emscripten_realloc_buffer, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_webgl_create_context": _emscripten_webgl_create_context, "emscripten_webgl_do_create_context": _emscripten_webgl_do_create_context, "emscripten_webgl_do_get_current_context": _emscripten_webgl_do_get_current_context, "emscripten_webgl_get_current_context": _emscripten_webgl_get_current_context, "emscripten_webgl_init_context_attributes": _emscripten_webgl_init_context_attributes, "emscripten_webgl_make_context_current": _emscripten_webgl_make_context_current, "floor": _floor, "flush_NO_FILESYSTEM": flush_NO_FILESYSTEM, "glActiveTexture": _glActiveTexture, "glAttachShader": _glAttachShader, "glBindBuffer": _glBindBuffer, "glBindTexture": _glBindTexture, "glBlendFunc": _glBlendFunc, "glBufferData": _glBufferData, "glClear": _glClear, "glClearColor": _glClearColor, "glCompileShader": _glCompileShader, "glCreateProgram": _glCreateProgram, "glCreateShader": _glCreateShader, "glDeleteProgram": _glDeleteProgram, "glDeleteShader": _glDeleteShader, "glDetachShader": _glDetachShader, "glDisable": _glDisable, "glDrawElementsInstanced": _glDrawElementsInstanced, "glEnable": _glEnable, "glEnableVertexAttribArray": _glEnableVertexAttribArray, "glGenBuffers": _glGenBuffers, "glGenTextures": _glGenTextures, "glGetAttribLocation": _glGetAttribLocation, "glGetError": _glGetError, "glGetProgramInfoLog": _glGetProgramInfoLog, "glGetProgramiv": _glGetProgramiv, "glGetShaderInfoLog": _glGetShaderInfoLog, "glGetShaderiv": _glGetShaderiv, "glGetUniformLocation": _glGetUniformLocation, "glLinkProgram": _glLinkProgram, "glShaderSource": _glShaderSource, "glTexImage2D": _glTexImage2D, "glTexParameteri": _glTexParameteri, "glTexSubImage2D": _glTexSubImage2D, "glUniform1f": _glUniform1f, "glUniform1i": _glUniform1i, "glUniform2f": _glUniform2f, "glUniformMatrix4fv": _glUniformMatrix4fv, "glUseProgram": _glUseProgram, "glVertexAttribDivisor": _glVertexAttribDivisor, "glVertexAttribPointer": _glVertexAttribPointer, "glViewport": _glViewport, "memcpy": _memcpy, "memset": _memset, "round": _round, "sbrk": _sbrk, "setTempRet0": _setTempRet0 };
...
var _web_view_malloc = Module["_web_view_malloc"] = function() {
  return Module["asm"]["web_view_malloc"].apply(null, arguments)
};

var _web_view_initialize = Module["_web_view_initialize"] = function() {
  return Module["asm"]["web_view_initialize"].apply(null, arguments)
};

var _web_view_zoom_at_screen_point = Module["_web_view_zoom_at_screen_point"] = function() {
  return Module["asm"]["web_view_zoom_at_screen_point"].apply(null, arguments)
};

var _web_view_resize = Module["_web_view_resize"] = function() {
  return Module["asm"]["web_view_resize"].apply(null, arguments)
};

var _web_view_translate = Module["_web_view_translate"] = function() {
  return Module["asm"]["web_view_translate"].apply(null, arguments)
};

var _web_view_layout_set = Module["_web_view_layout_set"] = function() {
  return Module["asm"]["web_view_layout_set"].apply(null, arguments)
};

var _web_view_layout_get = Module["_web_view_layout_get"] = function() {
  return Module["asm"]["web_view_layout_get"].apply(null, arguments)
};

var _web_grid_malloc = Module["_web_grid_malloc"] = function() {
  return Module["asm"]["web_grid_malloc"].apply(null, arguments)
};

var _web_grid_set = Module["_web_grid_set"] = function() {
  return Module["asm"]["web_grid_set"].apply(null, arguments)
};

var _web_ui_malloc = Module["_web_ui_malloc"] = function() {
  return Module["asm"]["web_ui_malloc"].apply(null, arguments)
};

var _web_ui_initialize = Module["_web_ui_initialize"] = function() {
  return Module["asm"]["web_ui_initialize"].apply(null, arguments)
};

var _web_ui_draw = Module["_web_ui_draw"] = function() {
  return Module["asm"]["web_ui_draw"].apply(null, arguments)
};

var _web_texture_update = Module["_web_texture_update"] = function() {
  return Module["asm"]["web_texture_update"].apply(null, arguments)
};

var _web_ui_blend_enabled = Module["_web_ui_blend_enabled"] = function() {
  return Module["asm"]["web_ui_blend_enabled"].apply(null, arguments)
};

var _web_core_grid_initialize = Module["_web_core_grid_initialize"] = function() {
  return Module["asm"]["web_core_grid_initialize"].apply(null, arguments)
};

var _web_core_tick = Module["_web_core_tick"] = function() {
  return Module["asm"]["web_core_tick"].apply(null, arguments)
};

var _web_core_toggle_hex_at_point = Module["_web_core_toggle_hex_at_point"] = function() {
  return Module["asm"]["web_core_toggle_hex_at_point"].apply(null, arguments)
};
