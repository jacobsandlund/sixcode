...
TEST(mesh)
{
	...
	_dd(m->stroke_indices[0], m->stroke_indices[1]);
	//=> 0, 1
	_dd(m->stroke_indices[2], m->stroke_indices[3]);
	//=> 1, 2
	_dd(m->stroke_indices[4], m->stroke_indices[5]);
	//=> 2, 3
	_dd(m->stroke_indices[6], m->stroke_indices[7]);
	//=> 3, 4
	_dd(m->stroke_indices[8], m->stroke_indices[9]);
	//=> 4, 5
	_dd(m->stroke_indices[10], m->stroke_indices[11]);
	//=> 5, 0

	_dd(m->stroke_indices[24574], m->stroke_indices[24575]);
	//=> 12287, 12282
