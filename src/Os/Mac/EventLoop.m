...
OsEventLoop *OsEventLoopCreate(void)
{
    ...
    @autoreleasepool {
        ...
        loop->until = (__bridge_retained void *)until;
...
void OsEventLoopRun(OsEventLoop *loop, OsEventQueue *queue)
{
    for (;;) {
        @autoreleasepool {
            NSDate *until = (__bridge NSDate *)loop->until;
            ...
            case NSEventTypeKeyDown:
                ...
                LogDebug(gLogManager.logs.os,
                         "Event key down with characters: '%s'",
            ...
            case NSEventTypeKeyUp:
                LogDebug(gLogManager.logs.os,
                         "Event key up with characters: '%s'",
                         nsEvent.characters.UTF8String);
            ...
            case NSEventTypeAppKitDefined:
                ...
                case NSEventSubtypeApplicationActivated:
                    LogDebug(gLogManager.logs.os,
                             "Event NSEventTypeAppKitDefined with subtype: "
                ...
                default:
                    LogDebug(gLogManager.logs.os,
                             "Event NSEventTypeAppKitDefined with unknown "
                             "subtype: %d",
                             nsEvent.subtype);
                    break;
                }
            ...
            case NSEventTypePeriodic:
                ...
                case NSEventSubtypePowerOff:
                    ...
                    LogDebug(gLogManager.logs.os,
                             "Event NSEventTypeSystemDefined with subtype: "
                ...
                case 7:
                    LogDebug(gLogManager.logs.os,
                             "Event NSEventTypeSystemDefined with subtype "
                             "7: clicking into/out of ???");
                    break;
                default:
                    LogDebug(gLogManager.logs.os,
                             "Event NSEventTypeSystemDefined with unknown "
                             "subtype");
                    break;
                }
